...
// End Branch or Unit submenu
      ...
      $settings = get_option( 'ut_options');
        ...
        ?>
                                             ...
                                             <li id="giving"><!-- LibAnswers Chat Widget 6690 - DeVine Button pop-out - White --><script type="text/javascript" src="//v2.libanswers.com/load_chat.php?hash=1a603c88b08462851bffe3e1e30977fe"></script><div id="libchat_1a603c88b08462851bffe3e1e30977fe"></div></li>
