 ...
 * Description: University Libraries - Home
 *
 * @package WordPress
...
<!-- Page Content Starts -->
						<div class="entry-content regwide">
							<!-- Begin One Search -->
							<div class="onesearch">
								<div id="libchat_cbb3e39658d3f35979d91f22200d30f3"></div><script type="text/javascript" src="https://v2.libanswers.com/load_chat.php?hash=cbb3e39658d3f35979d91f22200d30f3"></script>
...
<!-- End Search Box Include -->
							...
							<!-- End One Search -->
							<br class="clear">
							<div class="main-home-content"><?php the_content(); ?>
							<?php wp_link_pages( array( 'before' => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'utthehill' ) . '</span>', 'after' => '</div>', 'link_before' => '<span>', 'link_after' => '</span>' ) ); ?></div>
						</div><!-- .entry-content -->
