...
-->
                  <?php  get_template_part( 'library/partials/off-canvas-ag', 'page' ); ?>
        		</nav><!-- #site-navigation -->
        </div>
      </div>
	...
	<div id="primary" class="content-area">
      ...
      <h2 class="department"><a href="https://www.lib.utk.edu/agvet">Pendergrass Agriculture &amp; Veterinary Medicine Library</a>
      <small><a href="https://www.lib.utk.edu">University Libraries</a></small>  
<!--
       <?php 
